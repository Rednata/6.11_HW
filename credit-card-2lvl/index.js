...
const container = 
  el('div.container', 
    el('div.creditcard', front, back)
  );

const fieldName = el('div.field-container',
...
const fieldNumber = el('div.field-container',
  el('label', {for: 'cardnumber'}, 'Card Number'),
  el('input#cardnumber', 
    {pattern: '2-[0-9]{3}-[0-9]{3}', 
    inputmode: 'numeric'}), ccicon
);

const fieldDate = el('div.field-container',
  el('label', {for: 'expirationdate'}, 'Expiration (mm/yy)'),
  el('input#expirationdate', 
    {pattern: '[0-9]*', inputmode: 'numeric'})
);

const fieldCode = el('div.field-container',
  el('label', {for: 'securitycode'}, 'Security Code'),
  el('input#securitycode', {pattern: '[0-9]*', inputmode: 'numeric'})
);
...
//   svg(
//     'text', {transform:"matrix(1 0 0 1 574.4219 433.8095)", id:"svgexpire", class:"st2 st5 st9"}, '01/23'),
//   svg(
